...
%      appliedf to the GUI before basic_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 22-Apr-2018 10:05:35
...
conn = database('students_details','user','root');
...
if (strcmp(handles.start_monitoring.String,'Start Monitoring') == 1)
   ...
   %%---------------looping------------
    ...
    save timedb.mat time;
    query = sprintf('ALTER TABLE students ADD C%d int(2) NOT NULL',loop) ;
    query1 = sprintf('ALTER TABLE student_report ADD C%d int(2)',loop) ;
